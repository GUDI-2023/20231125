...
parser.add_argument('--epochs', type=int, default=300,#default = 100000
                    help='maximum number of epochs')
parser.add_argument('--patience', type=int, default=200,
                    help='patience for earlystopping')
parser.add_argument('--pooling_layer_type', type=str, default='GraphConv',
                    help='GCNConv/SAGEConv/ChebConv/GATConv/GraphConv')
parser.add_argument('--feature_fusion_type', type=str, default='GATConv',
                    help='GATConv')
parser.add_argument('--save_path', type=str, default='/Users/lixujia/Desktop/GSAPool-master/data/OTC',
