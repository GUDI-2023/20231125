...
class DeepDetector(Detector, ABC):
    ...
    **kwargs
    ...
    def fit(self, data, label=None):
        ...
        # if not self.gan or self.model == 'dominant':
        ...
        for epoch in range(self.epoch):
            ...
            for sampled_data in loader:
                ...
                if self.model =='dominant' or True:
                    loss, score = self.forward_model(sampled_data)
                    # print(epoch, loss)

                # print("sampled_data.x.size()", sampled_data.x.size()) torch.Size([2708, 1433])
                else:
                    loss, score = self.forward_model(sampled_data)
    ...
    def fit2(self, data, label=None):
        ...
        self.opt_s = torch.optim.Adam([
            {'params': self.model.domi.parameters()}],
        ...
        optimizer = torch.optim.Adam([
            {'params': self.model.encoder.parameters()},
            {'params': self.model.domi.shared_encoder.parameters()},
            {'params': self.model.gsa.parameters()}],
                                     lr=self.lr,
                                         weight_decay=self.weight_decay)
        ...
        for epoch in range(self.epoch):
            ...
            for sampled_data in loader:
                ...
                if self.model =='dominant' or True:
                    loss, score = self.forward_diffusion(sampled_data)
                    # print(epoch, loss)
